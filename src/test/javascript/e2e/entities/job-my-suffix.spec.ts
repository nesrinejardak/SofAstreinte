...
describe('Job e2e test', () => {
    ...
    it('should load Jobs', () => {
        ...
        expect(jobComponentsPage.getTitle()).toMatch(/sofAstreinteApp.job.home.title/);
    ...
    it('should load create Job dialog', () => {
        ...
        expect(jobDialogPage.getModalTitle()).toMatch(/sofAstreinteApp.job.home.createOrEditLabel/);
        jobDialogPage.close();
    });
