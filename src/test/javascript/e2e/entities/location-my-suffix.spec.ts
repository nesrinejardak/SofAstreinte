...
describe('Location e2e test', () => {
    ...
    it('should load Locations', () => {
        ...
        expect(locationComponentsPage.getTitle()).toMatch(/sofAstreinteApp.location.home.title/);
    ...
    it('should load create Location dialog', () => {
        ...
        expect(locationDialogPage.getModalTitle()).toMatch(/sofAstreinteApp.location.home.createOrEditLabel/);
