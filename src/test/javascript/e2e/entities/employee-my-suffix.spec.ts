...
describe('Employee e2e test', () => {
    ...
    it('should load Employees', () => {
        ...
        expect(employeeComponentsPage.getTitle()).toMatch(/sofAstreinteApp.employee.home.title/);
    ...
    it('should load create Employee dialog', () => {
        ...
        expect(employeeDialogPage.getModalTitle()).toMatch(/sofAstreinteApp.employee.home.createOrEditLabel/);
